...
def main() -> None:
    ...
    if args.read_palette_from_stdin:
        ...
        palette = quantize_pitches(
            generate_pitch_palette(reference_pitch, intervals, min_pitch, max_pitch), scale_ratio
        )
...
def handle_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Creates a collection of pitches, can export the score as PDF and play the score."
    )
    parser.add_argument(
        "-p",
        metavar="--play",
    ...
    parser.add_argument(
        "--intervals",
        dest="read_intervals_from_stdin",
        type=bool,
        action=argparse.BooleanOptionalAction,
        default=False,
    ...
    parser.add_argument(
        "-i",
        metavar="--pipe-palette",
        dest="read_palette_from_stdin",
        type=bool,
        action=argparse.BooleanOptionalAction,
        default=False,
    ...
    parser.add_argument(
        "--output-intervals",
        dest="output_intervals",
        type=bool,
        action=argparse.BooleanOptionalAction,
        default=False,
        help="output intervals to tmp folder",
    )
    parser.add_argument("--log-level", dest="log_level", type=str, default="INFO", help="set log level")
